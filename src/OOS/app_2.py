...
def build(app):
    ...
    # n_input = toga.TextInput()
    # k_input = toga.TextInput()
    # j_input = toga.TextInput()
    # s_input = toga.TextInput()

    # m_label = toga.Label("The values for parameters m:", style=Pack(text_align=RIGHT))
    # n_label = toga.Label("The values for parameters n:", style=Pack(text_align=LEFT))
...
def main():
    return toga.App("An Optimal Sample Selection System", startup=build)
